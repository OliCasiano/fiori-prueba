		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoice List",
									"targetURL": "#capgeminiinvoice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"capgeminiinvoice-display": {
								"semanticObject": "capgeminiinvoice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=capgemini.invoice",
									"url": sap.ui.require.toUrl("capgemini/invoice")
								}
							}
						}
					}
